...
class DataExporter:
    ...
    def __connect_to_database(self) -> None:
        ...
        Raises:
            Exception: If a connection to the database cannot be establish.
        """
    ...
    def __fetch_from_database(self, start_timestamp, end_timestamp) -> tuple | None:
        ...
        Returns:
            list: A list containing booking data (num_booking, total_amount) or None if an error occurs.
        """
        ...
        """
        logging.info(
            "Exracting booking data from database for start timestamp=%s and end_timestamp=%s",
            start_timestamp,
            end_timestamp
        )
        result = None
        ...
        try:
            ...
            logging.info(
                "Successfully exracted booking data from database for start timestamp=%s and end_timestamp=%s",
                start_timestamp,
                end_timestamp,
            )
        except Exception as e:
            logging.error(
                "Error occurred while extracting booking data from database: %s", e
            )
            return result
    ...
    def __convert_to_excelsheet(self, data: list, sheet_name: str):
        ...
        try:
            ...
            logging.info("Successfully inseted data into the excelsheet")
    ...
    def generate_excelsheet(
        ...
        sheet_name: str = "Bookings_Data.xslx",
    ) -> bool:
        """
        ...
        Args:
            start_timestamp (datetime): The start of the time range.
            end_timestamp (datetime): The end of the time range.
            sheet_name (str, optional): Name of the Excel sheet to be created. Defaults to "Bookings_Data.xlsx".
